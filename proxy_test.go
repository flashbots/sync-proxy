...
// 		require.NotNil(t, backend.proxyService.bestBeaconEntry)
// 		require.Equal(t, backend.proxyService.bestBeaconEntry.LastSeen, uint64(1))

// 		backend.request(t, higherTimestampFcu, from)
// 		require.NotNil(t, backend.proxyService.bestBeaconEntry)
// 		require.Equal(t, uint64(10), backend.proxyService.bestBeaconEntry.LastSeen)
// 	})
...
// 		backend.request(t, higherTimestampFcu, from)
// 		require.NotNil(t, backend.proxyService.bestBeaconEntry)
// 		require.Equal(t, backend.proxyService.bestBeaconEntry.LastSeen, uint64(10))
